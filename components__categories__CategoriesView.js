...
export const CategoriesView = () => {
    ...
    const [color, setColor] = useState('#0000fe');
    const presetColors = [
        '#0000fe', '#3b82f6', '#8b5cf6', '#ec4899', '#f59e0b',
