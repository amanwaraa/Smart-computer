/* Smart computer persistent ESC/POS printer manager.
...
const PREF_KEY = 'smart-computer-printer-pref-v1';
const BLE_SERVICES = [
...
export const smartPrinter = (typeof window !== 'undefined' && window.__SMART_COMPUTER_PRINTER__) || new SmartPrinterManager();
if (typeof window !== 'undefined') window.__SMART_COMPUTER_PRINTER__ = smartPrinter;
