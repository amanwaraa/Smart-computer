...
import { BarcodeCameraModal } from './components__pos__CameraScannerModal.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { calculateUnitConversions, formatStockBreakdown } from './utils__unitTree.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { exportToCSV } from './utils__export.js?v=7.9.4.40-smart-computer-products-syntax-fix';
...
export const ProductsView = () => {
    ...
    const handleSaveModal = async (e) => {
        ...
        delete finalProd.salesChannel;
        delete finalProd.expiryDate;
