...
import { AppProvider, useApp } from './context__AppContext.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { Header } from './components__common__Header.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { Sidebar } from './components__common__Sidebar.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { BottomNav } from './components__common__BottomNav.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { Toast } from './components__common__Toast.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { SyncModal } from './components__sync__SyncModal.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { POSView } from './components__pos__POSView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { DashboardView } from './components__dashboard__DashboardView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { SalesView } from './components__sales__SalesView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { PurchasesView } from './components__purchases__PurchasesView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { ProductsView } from './components__products__ProductsView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { CategoriesView } from './components__categories__CategoriesView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { InventoryView } from './components__inventory__InventoryView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { CustomersView } from './components__customers__CustomersView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { SuppliersView } from './components__suppliers__SuppliersView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { AccountsView } from './components__accounts__AccountsView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { ExpensesView } from './components__expenses__ExpensesView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { VouchersView } from './components__vouchers__VouchersView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { EmployeesView } from './components__employees__EmployeesView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { BarcodesView } from './components__barcodes__BarcodesView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { ReportsView } from './components__reports__ReportsView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { TrashView } from './components__trash__TrashView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { SettingsView } from './components__settings__SettingsView.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { ThermalReceiptModal } from './components__pos__ThermalReceiptModal.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { DEFAULT_LOGO_DATA_URL } from './brand__logo.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { LoginGate } from './components__auth__LoginGate.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { canAccessTab, firstAllowedTab } from './utils__permissions.js?v=7.9.4.40-smart-computer-products-syntax-fix';
...
const MainLayout = () => {
  ...
  useEffect(() => {
    ...
    if (!migrated) {
      ...
      const oldDefaultNames = new Set(['Smart computer','الميزان ماركت','AlMezan Market POS']);
  ...
  }, [activeTab, currentUser, activeEmployee, isLoaded]);
  ...
  if (!isLoaded && !forceEnter) {
    return h('div', { className:'min-h-[100dvh] w-screen flex flex-col items-center justify-center bg-slate-50 text-slate-900 px-4' },
      h('img', { src:DEFAULT_LOGO_DATA_URL, alt:'Smart computer', className:'w-20 h-20 rounded-2xl object-cover shadow-xl mb-4 bg-white' }),
      h('h2', { className:'text-xl font-black tracking-tight' }, 'Smart computer'),
  ...
  const screen = (() => {
    ...
    if (activeTab === 'settings') return h(ScrollScreen, null, h(SettingsView));
    return h(POSView);
  })();
...
export default function App() {
  return h(LoginGate, null, h(AppProvider, null, h(MainLayout)));
}
