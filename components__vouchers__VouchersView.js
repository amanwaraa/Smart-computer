...
import { exportToCSV, printElementOnly, warmExportLibraries } from './utils__export.js?v=7.9.4.40-smart-computer-products-syntax-fix';
import { downloadProfessionalTablePDF, downloadProfessionalTableImage, downloadProfessionalVoucherPDF, downloadProfessionalVoucherImage } from './utils__professionalExport.js?v=7.9.4.40-smart-computer-products-syntax-fix';
...
export const VouchersView = () => {
  ...
  const voucherPaper = viewingVoucher ? h('div', {
    ...
    h('div',{className:'text-center pb-3 border-b border-dashed border-gray-300'},
      ...
      h('h3',{className:'text-base font-black leading-tight'},settings.storeName || 'Smart computer'),
    ...
    h('div',{className:'mt-5 text-center text-[8px] text-gray-400'},`نظام ${settings.storeName || 'Smart computer'} - سند مالي رسمي`)
  ) : null;
