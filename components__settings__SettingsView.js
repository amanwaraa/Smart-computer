...
export const SettingsView = () => {
    ...
    const handleExportBackup = async () => {
        ...
        link.href = url;
        link.download = `Smart_Computer_Backup_${new Date().toISOString().split('T')[0]}.json`;
        link.rel = 'noopener';
    ...
    const handleInstallApp = async () => {
        ...
        if (result?.installed)
            showToast('تم بدء تثبيت تطبيق Smart computer على الجهاز', 'success');
